        ...
        <div class="hidden bg-center bg-cover lg:flex lg:w-1/2" style="background-image: url('{{ asset('images/2024-03-08.jpg') }}')">
            <div class="flex items-center justify-center w-full bg-text/50">
                <div class="p-12 text-center text-white">
                    <h1 class="mb-4 text-5xl font-bold">Bergabunglah Dengan Kami</h1>
                    <p class="text-xl">Dapatkan kemudahan berbelanja dan penawaran spesial</p>
                </div>
            </div>
        </div>
        ...
        <div class="flex items-center justify-center w-full p-8 lg:w-1/2">
            <div class="w-full max-w-md">
                <div class="mb-10 text-center">
                    ...
                    <h2 class="mb-2 text-4xl font-bold text-gray-900">Buat Akun Baru</h2>
                    <p class="text-gray-600">Sudah punya akun? <a href="{{ route('login') }}" class="font-medium text-primary hover:text-primary/80">Masuk disini</a></p>
                </div>
                    ...
                    <div>
                        <div class="relative">
                            <input type="text" name="name" id="name" required
                                class="w-full px-4 py-3 border-gray-200 rounded-lg bg-gray-50 focus:ring-2 focus:ring-primary/20 focus:border-primary"
                    ...
                    <div>
                        <div class="relative">
                            ...
                            <button type="button"
                                    ...
                                    class="absolute inset-y-0 right-0 flex items-center pr-3 text-gray-400 hover:text-gray-600">
                                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24" id="password_confirmation-icon">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13.875 18.825A10.05 10.05 0 0112 19c-4.478 0-8.268-2.943-9.543-7a9.97 9.97 0 011.563-3.029m5.858.908a3 3 0 114.243 4.243M9.878 9.878l4.242 4.242M9.88 9.88l-3.29-3.29m7.532 7.532l3.29 3.29M3 3l3.59 3.59m0 0A9.953 9.953 0 0112 5c4.478 0 8.268 2.943 9.543 7a10.025 10.025 0 01-4.132 5.411m0 0L21 21" />
                                </svg>
                            </button>
                        </div>
